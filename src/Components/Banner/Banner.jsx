    ...
    return (
        <div className="mt-6 lg:mt-[54px] p-5 lg:p-0 background bg-cover h-[371px] w-auto lg:h-[636px] lg:w-[1400px] flex flex-col justify-center items-center">
            <div className=''>
                ...
                <p className='mb-[24px] lg:mb-[40px] lg:text-18px text-[#FFFFFF]'>Savor the richness of our recipes, crafted with love and tradition,<br/> each bite a symphony of flavors that delight the senses. </p>
